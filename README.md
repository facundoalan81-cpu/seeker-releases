...
<p align="center">Artista - Título, o un link de Spotify, SoundCloud o YouTube.<br>Seeker lo busca en todas tus cuentas y baja cada track en calidad real, verificada.</p>
...
Escribís *Artista - Título* — o pegás un link de Spotify, SoundCloud o YouTube, track o playlist entera — y Seeker lo busca **fuente por fuente**, de la mejor calidad a la última, hasta que aparece. Baja **un solo archivo**: el mejor que encontró.

**Muzrec · Muzbase · Soulseek · YouTube · SoundCloud**, y si en ninguna está, sale a buscarlo por la web abierta.
...
3. La app te recibe con **tres pasos**. En el primero conectás las cuentas que tengas: **Conectar** abre la página oficial de cada sitio adentro de Seeker y entrás con tu mail y contraseña. Seeker guarda la sesión, nunca tu contraseña. Soulseek se conecta con usuario y contraseña ahí mismo.
